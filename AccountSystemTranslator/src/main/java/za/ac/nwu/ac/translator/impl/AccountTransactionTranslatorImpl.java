//This class implements the account transaction translator's methods
...
public class AccountTransactionTranslatorImpl implements AccountTransactionTranslator
{
    ...
    public AccountTransactionDto getAccountTransactionByAccId(String accountType)
    {
        try
        {
            AccountTransaction accountTransaction = accountTransactionRepository.getAccountTransactionByAccId(accountType);
            return new AccountTransactionDto(accountTransaction);
        }
        catch (Exception e)
        {
    ...
    @Override
    public AccountTransactionDto getAccountTransactionByMiles(String miles)
    {
        try
        {
            AccountTransaction accountTransaction = accountTransactionRepository.getAccountTransactionByMiles(miles);
            return new AccountTransactionDto(accountTransaction);
        }
        catch (Exception e)
        {
