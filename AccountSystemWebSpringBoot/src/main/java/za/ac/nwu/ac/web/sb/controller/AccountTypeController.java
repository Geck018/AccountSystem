//This is the rest controller for the account type table
...
@GetMapping("/all")
    ...
    @GetMapping("{mnemonic}")
    @ApiOperation(value = "Fetches the specified AccountType", notes = "Fetches the AccountType according to the given mnemonic")
    @ApiResponses(value = {
