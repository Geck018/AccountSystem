...
//    @Query(value = "INSERT INTO AccountType at (at.accountTypeName, at.mnemonic, at.creationDate) VALUES (:accountTypeName, :mnemonic, :creationDate )")
//    AccountTypeDto create(String mnemonic, String accountTypeName, LocalDate creationDate);
